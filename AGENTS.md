...
## Deploy scope (this folder)

This is the **lab** repository: **workflows** and **explorations** (BOS variants, permission cards, form preview) only — not the milestone MVP surface and not the default full product demo (use [**x99-vision**](https://github.com/dil-wrahn/x99-vision)). Read [`PROTOTYPE_SCOPE.md`](./PROTOTYPE_SCOPE.md) and [`PROTOTYPES.md`](./PROTOTYPES.md). Vision archive folders here are **frozen copies**, not live sync targets.
...
This is a proof-of-concept prototype for the **Custom Attributes** feature of the Object Library (ARC Core). Before implementing any feature:

1. **Canonical requirements:** [Confluence — Custom attributes prototype docs](https://diligentbrands.atlassian.net/wiki/spaces/RCP/folder/6953959468).
2. **Working copies in-repo:** `src/docs/` — may lag Confluence; see [`src/docs/README.md`](./src/docs/README.md).

...
import {
  ...
  outgoingGuardsAndActionsTotals,
} from "./draftTypes.js";
import { WorkflowStateGuardsActionsChips } from "./WorkflowStateGuardsActionsChips.js";
...
const StateNode: FC<StateNodeProps> = ({ state, isInitial, isSelected, onClick }) => {
  ...
  const { guards: guardTotal, actions: actionTotal } = outgoingGuardsAndActionsTotals(state);
  ...
  return (
    ...
    >
      <Stack gap={1} height="100%">
        ...
        {!isEmpty && (
          <WorkflowStateGuardsActionsChips guardTotal={guardTotal} actionTotal={actionTotal} />
        )}
      </Stack>
    </Box>
  );

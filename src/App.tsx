...
import WorkflowsGlobalInstancesArchivePage from "./pages/WorkflowsGlobalInstancesArchivePage.js";
...
import WorkflowManagementVisionArchivePage from "./pages/WorkflowManagementVisionArchivePage.js";
import WorkflowTemplateVisionArchiveEditorPage from "./pages/WorkflowTemplateVisionArchiveEditorPage.js";
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route
          path="/explorations/workflows-global-instances-archive"
          element={<WorkflowsGlobalInstancesArchivePage />}
        />
        <Route path="/explorations/workflows-vision-archive" element={<WorkflowManagementVisionArchivePage />} />
        <Route
          path="/explorations/workflows-vision-archive/template/edit"
          element={<WorkflowTemplateVisionArchiveEditorPage />}
        />

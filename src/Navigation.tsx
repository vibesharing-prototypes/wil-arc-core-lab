  ...
  return (
    ...
    >
      ...
      >
        ...
        <RoutedNavLink to="/explorations/workflows-global-instances-archive" label={STR.explorations.workflowsGlobalInstancesArchive.navLabel}>
          <FlowsIcon slot="icon" />
        </RoutedNavLink>
        <RoutedNavLink to="/explorations/workflows-vision-archive" label="Workflows (Vision archive)">
          <FlowsIcon slot="icon" />
        </RoutedNavLink>
